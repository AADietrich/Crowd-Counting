...
# x used for main sequential path through model, s[x] used for lateral connections, o for intermediate output
...
x = layers.add((x,s2))
x = layers.Conv2D(256,3,activation="relu",padding="same")(x)
o = layers.Conv2D(1,1,activation="relu",padding="same")(x)
x = layers.Conv2D(128,3,activation="relu",padding="same")(o)
...
model = keras.Model(inputs=inputs, outputs=outputs, name="mrcnet_model")
